    ...
    <header class="introHeader">
        <nav class="navbar">
            ...
            <div class="nav-buttons">
                <button onclick="window.location.href='../controllers/login.php';" class="btn signup">Login</button>
                <button onclick="window.location.href='../controllers/signup.php';" class="btn login">Signup</button>
            </div>
        </nav>
    </header>
    <section class="intro">
